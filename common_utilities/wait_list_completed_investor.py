...
<head>
    ...
    <link rel="stylesheet" href="{bs}" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" />
    <style>
        body,
...
​
        p,
        .sizing {{font-family: "Roboto", sans-serif !important;}}
​
...
​
        .sizing {{font-size: 19px !important;}}
​
...
​
        .font-color-prime {{color: #5e51f4;}}
​
        .font-18 {{font-size: 18px;}}
​
        .font-16 {{font-size: 16px;  position: relative;top: -20px; }}
​
        .font-15 {{font-size: 15px;text-align: center; position: relative;top: -15px;}}
​
        .how-it-works-container {{position: relative;top: -15px;height: 525px; width: 100%;align-items: center; }}
​
        .how-it-works-container .processLine {{ width: 24px; }}
​
        .how-it-works-container .row {{height: 160px; align-items: center;   }}
​
        .how-it-works-container .row .img {{ display: flex;justify-content: left; align-self: center;  }}
​
        .how-it-works-container .row .img img {{ width: 100px;  margin-left: 5px;   }}
​
        .col-10 {{ padding-left: 30px;  }}
​
        button {{
                height: 50px;
                width: 100%;
...
​
        @media only screen and (max-width: 800px) {{
                .logo {{padding-left: 5%; margin: 0px !important; text-align: left !important;}}
​
                .container {{margin: 0px !important; padding: 0% !important; border: none !important; box-shadow: none !important; width: 100% !important;
                }}
​
                .hook {{display: block; margin: auto; width: 80%; }}
​
                h1 {{ font-size: 20px !important; }}
​
                .sizing {{ font-size: 17px !important; }}
​
                .title {{padding-left: 5% !important;margin-left: 0% !important;}}​
                .footer {{font-size: 15px; margin: 0%; width: 100%; }}
​                button {{ margin-left: 0px !important;  }}
​
                .font-18 {{font-size: 16px !important;text-align: center !important; }}
​
                .w-25 {{ display: block; margin: auto;}}
        }}
    </style>
</head>
​
<body>
    <div class="container">
        <div class="logo">
            <img src="https://angelfund-company-images.s3-us-west-1.amazonaws.com/Angelfund.ai+Logo.png"
                style="height: 30px;" />
        </div>
        <div class="title">
            <h1>
        ...
        <div class="hook">
            ...
            <p class="sizing">
                ...
                start introducing you to relevant startups on Angelfund.ai.
            </p>
            <p class="sizing">
                        ...
                        <div class="row mb-0">
                            ...
                            <div class="col-md-9 col-10">
                                ...
                                <span class="font-16 font-roboto">
                                    You've already told us what type of startups you're looking for.
                                </span>
                            </div>
                        </div>
                        <div class="row mb-0">
                            ...
                            <div class="col-md-9 col-10 ">
                                <p class="font-weight-bold font-18 font-roboto font-color-prime">
                                    We'll show you relevant deals.
                                </p>
                                <p class="font-16 font-roboto">
                                    Spend more time looking at the startups you care about.
                                </p>
                            </div>
                        </div>
                        <div class="row mb-0">
